<template>
  <el-card v-for="(item) in props.blanks" :key="item.id" style="margin-bottom: 12px">
    <div class="card-header">
      <div>
        <span style="color: #409eff;">【填空题】</span>
...
function deleteQuestion(e) {
  https.post('/teacher/delete_question', {'question_id':e.id,'question_type':'填空题'}).then(res=>{
