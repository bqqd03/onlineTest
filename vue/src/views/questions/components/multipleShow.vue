<template>
  <el-card v-for="(item) in props.multiples" :key="item.id" style="margin-bottom: 12px">
    <div class="card-header">
      <div>
        <span style="color: #409eff;">【多选题】</span>
    ...
    <el-checkbox-group  :model-value="item.answers" style="margin-left: 10px;display: flex;flex-flow: column;">
...
function deleteQuestion(e) {
  https.post('/teacher/delete_question', {'question_id':e.id,'question_type':'多选题'}).then(res=>{
